...
const okpToJWK = {
  private (crv, keyObject) {
    ...
    const OneAsymmetricKey = asn1Dict.get('OneAsymmetricKey')
  ...
  public (crv, keyObject) {
    ...
    const PublicKeyInfo = asn1Dict.get('PublicKeyInfo')
...
const keyObjectToJWK = {
  rsa: {
    private (keyObject) {
      ...
      const PrivateKeyInfo = asn1Dict.get('PrivateKeyInfo')
    ...
    public (keyObject) {
      ...
      const PublicKeyInfo = asn1Dict.get('PublicKeyInfo')
      const RSAPublicKey = asn1Dict.get('RSAPublicKey')
  ...
  ec: {
    private (keyObject) {
      ...
      const PrivateKeyInfo = asn1Dict.get('PrivateKeyInfo')
      const ECPrivateKey = asn1Dict.get('ECPrivateKey')
