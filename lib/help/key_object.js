...
asn1Dict.AlgorithmIdentifier = asn1.define('AlgorithmIdentifier', require('./algorithm_identifier'))
asn1Dict.PrivateKeyInfo = asn1.define('PrivateKeyInfo', require('./private_key_info')(asn1Dict.AlgorithmIdentifier))
asn1Dict.PublicKeyInfo = asn1.define('PublicKeyInfo', require('./public_key_info')(asn1Dict.AlgorithmIdentifier))
asn1Dict.PrivateKey = asn1.define('PrivateKey', require('./private_key'))
asn1Dict.OneAsymmetricKey = asn1.define('OneAsymmetricKey', require('./one_asymmetric_key')(asn1Dict.AlgorithmIdentifier, asn1Dict.PrivateKey))
asn1Dict.RSAPrivateKey = asn1.define('RSAPrivateKey', require('./rsa_private_key'))
asn1Dict.RSAPublicKey = asn1.define('RSAPublicKey', require('./rsa_public_key'))
